  ...
  <div class="row">
      <form  name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <p> ราคา </p>
            <input type="number"  name="price" class="form-control" required placeholder="ราคา" value="<?php echo $price; ?>"/>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
            <p> จำนวนที่มีในคลัง </p>
            <input type="number"  name="stock" class="form-control" required placeholder="จำนวนที่มีในคลัง" value="<?php echo $stock; ?>"/>
          </div>
        </div>
            <div class="form-group">
          <div class="col-sm-12">
